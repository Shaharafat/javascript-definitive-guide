...
var Set = (function invoacation() {
  function Set() {
    // This constructor function is a local variable.
  ...
  Set.prototype.contains = function (value) {
    // Note that we call v2s(), not the heavily prefixed set.v2s()
  ...
  /*
   * These are helper function and variables use bt the methods above
   ...
   */
  return Set;
})(); // invoke the function immediately after defining itna
